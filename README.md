...
Hyungtaek Jung and Daniel Ortiz-Barrientos: **_EasyFM_**: An **Easy** software suite for **F**ile **M**anipulation of Next Generation Sequencing data on desktops, [biorxiv](https://www.biorxiv.org/content/10.1101/2021.09.29.462291v1).
...
### 3.5 FAQ
We encourage users to use the [Issues](https://github.com/TaekAndBrendan/EasyFM/issues). For further enquiries (including suggestion).
